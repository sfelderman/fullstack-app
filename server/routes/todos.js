...
router.get('/todos', (req, res)=>{
  Todo.find({ ...req.params})   //Returns an array.
  .then((todos)=>{
...
// 	res.send(await Todo.find({ ...req.query }));
// });
...
//   const { id } = req.params;
//   await Todo.findByIdAndUpdate(id, { ...req.body }, { new: true }, (err, data) => res.send(err || data));
// 	// res.send(await Todo.findByIdAndUpdate(id, ...req.body));
// });
